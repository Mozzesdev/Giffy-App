...
const fetchGifs = async ({ keyword, limit, signal }) => {
...
export default async function getAutoComplete(keyword, signal) {
  const gifs = await fetchGifs({ keyword, limit: 3, signal });
